...
ADD_TO_WORK_DIR "a17xxx" "vendor" "bin/hw/wpa_supplicant" 0 2000 755 "u:object_r:hal_wifi_supplicant_default_exec:s0"

LOG_STEP_IN "- Adding \"libhwui.so\" from a17xxx"
ADD_TO_WORK_DIR "a17xxx" "system" "system/lib/libhwui.so" 0 0 644 "u:object_r:system_lib_file:s0"
ADD_TO_WORK_DIR "a17xxx" "system" "system/lib64/libhwui.so" 0 0 644 "u:object_r:system_lib_file:s0"
LOG_STEP_OUT
